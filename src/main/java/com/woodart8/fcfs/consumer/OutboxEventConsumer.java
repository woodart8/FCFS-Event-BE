...
public class OutboxEventConsumer {
    ...
    public void consume(String message) {
        try {
            ...
            JsonNode payloadNode = JsonConverter.readTree(innerPayload);
            long eventId = payloadNode.get("eventId").asLong();
